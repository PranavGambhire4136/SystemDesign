...
#include "Strategies/UpiStrategies.h"
#include "Factory/NowOrderFactory.h"
#include "Factory/ScheduleOrder.h"
...
public:
    ...
    Order* checkoutNow(User* user, const string& orderType, PaymentStrategies* paymentStrategy) {
        return checkout(user, orderType, paymentStrategy, new NowOrderFactory());
    }

    Order* checkoutScheduled(User* user, const string& orderType, PaymentStrategies* paymentStrategy, const string& scheduleTime) {
    ...
    Order* checkout(User* user, const string& orderType, 
        PaymentStrategies* paymentStrategy, OrderFactory* orderFactory) {
